package com.mochamadahya.happyplace.callback
...
abstract class SwipeToDeleteCallback(context: Context) :
    ...
    override fun onChildDraw(
        ...
        val deleteIconTop = itemView.top + (itemHeight - intrinsicHeight) /
                2
    ...
    private fun clearCanvas(c: Canvas?, left: Float, top: Float, right:
    Float, bottom: Float) {
